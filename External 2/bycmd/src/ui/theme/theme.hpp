#pragma once
#include "imgui.h"
#include "imgui_internal.h"   // theme.hpp
#include <string>
...
namespace style {
    ...
    inline bool popup_interacting = false;
    inline bool frame_clicked = false;  // Track if any click happened this frame
    ...
    bool popup();
    void close();
    void set_popup_rect(const ImRect& rect);
    void popups();
}
